...
movie1 = load_gratings(5)
movie2 = load_gratings(6)
movie3 = load_gratings(7)
movie4 = load_gratings(8)
...
for layer in range(4):
    ...
    plt.savefig(f'part2_4_R_layer{layer + 1}.png')
    plt.show()
...
for layer in range(4):
    ...
    plt.legend() # to show the labels
    plt.savefig(f'part2_4_H_layer{layer + 1}.png')
    plt.show()