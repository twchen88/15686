...
imsave('part2_5_pred1.png', grid4.detach().numpy().transpose(1, 2, 0))
...
plt.savefig('part2_5_layer1.png')
...
plt.savefig('part2_5_layer2.png')
...
plt.savefig('part2_5_layer3.png')
...
plt.savefig('part2_5_layer4.png')