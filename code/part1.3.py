...
imsave('part1_3_truth1.png', grid1.detach().numpy().transpose(1, 2, 0))

truth2 = movie1[0, 0:10]
grid2 = torchvision.utils.make_grid(truth2, nrow = 5)
imsave('part1_3_truth2.png', grid2.detach().numpy().transpose(1, 2, 0))

truth3 = movie3[0, 0:10]
grid3 = torchvision.utils.make_grid(truth3, nrow = 5)
imsave('part1_3_truth3.png', grid3.detach().numpy().transpose(1, 2, 0))

pred1 = predictions1[0, 0:10]
grid4 = torchvision.utils.make_grid(pred1, nrow = 5)
imsave('part1_3_pred1.png', grid4.detach().numpy().transpose(1, 2, 0))

pred2 = predictions2[0, 0:10]
grid5 = torchvision.utils.make_grid(pred2, nrow = 5)
imsave('part1_3_pred2.png', grid5.detach().numpy().transpose(1, 2, 0))

pred3 = predictions3[0, 0:10]
grid6 = torchvision.utils.make_grid(pred3, nrow = 5)
imsave('part1_3_pred3.png', grid6.detach().numpy().transpose(1, 2, 0))